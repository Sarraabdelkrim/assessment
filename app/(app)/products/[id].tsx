      ...
      <View style={[style.content, { backgroundColor: colors.background }]}>
        ...
        >
          <View style={style.stat}>
            <Text style={[style.statValue, { color: colors.primary }]}>
              {product.stock}
            </Text>
            <Text style={[style.statLabel, { color: colors.textMuted }]}>
              In stock
            </Text>
          </View>
        ...
        >
          ...
          <Text style={style.btnText}>{t("cart.add")}</Text>
        </TouchableOpacity>

        
        <TouchableOpacity
          onPress={handleEdit}
          style={[style.editBtn, { backgroundColor: colors.surface, borderColor: colors.border }]}
        >
          <Ionicons name="pencil" size={18} color={colors.text} />
          <Text style={[style.editBtnText, { color: colors.text }]}>
            {t("editProduct.editButton")}
          </Text>
        </TouchableOpacity>
      </View>
    </ScrollView>
...
const styles = (colors: typeof lightColors) =>
  StyleSheet.create({
    ...
    title: { fontSize: 22, fontFamily: Fonts.brandBold, letterSpacing: -0.3 },
    ...
    statValue: { fontSize: 18, fontFamily: Fonts.brandBold },
    ...
    editBtnText: { fontFamily: Fonts.brandBold, fontSize: 16 },
  });